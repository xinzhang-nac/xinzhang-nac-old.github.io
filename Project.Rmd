...
|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
|DTFLR  | Linear Model | Adaptive Tree Lasso | $m = O(1)$  | $n \rightarrow \infty$ | Distributed Data Integration | [Preprint](https://arxiv.org/pdf/1905.11549.pdf) | 
|SHAPLM | Partial Linear Model | Forest Lasso | $m \rightarrow \infty$  | $n = O(1)$  | Image Segmentation | [Preprint]() | 
</center>
<center>
|   |    |     | 
|:-:|:-:|:-:|
